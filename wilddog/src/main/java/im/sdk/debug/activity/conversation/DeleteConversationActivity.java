...
public class DeleteConversationActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.bt_single_delete) {
            mTv_info.setText("");
        ...
        } else if (i == R.id.bt_group_delete) {
            mTv_info.setText("");
        ...
        } else if (i == R.id.bt_get_conversation) {
